...
local themeStyles = {
    ...
    Serpent = {
         SchemeColor = Color3.fromRGB(0, 166, 58), --section
...
azulclaro = {
    SchemeColor = Color3.fromRGB(105, 66, 255), --section
...
Gris = {
    SchemeColor = Color3.fromRGB(75,75,75), --section
...
lila = {
SchemeColor = Color3.fromRGB(85,40,215), --section
    Background = Color3.fromRGB(36, 37, 43), --fondo
    Header = Color3.fromRGB(28, 29, 34), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(32, 32, 38), --buttons
...
blue = {
SchemeColor = Color3.fromRGB(61,136,240,255), --section
    Background = Color3.fromRGB(36, 37, 43), --fondo
    Header = Color3.fromRGB(28, 29, 34), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(32, 32, 38), --buttons
...
Discord = {
SchemeColor = Color3.fromRGB(63,135,251,255), --section
...
Spotify = {
SchemeColor = Color3.fromRGB(28,185,89,255), --section
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "Sentinel2" then
        themeList = themeStyles.Sentinel2
elseif themeList == "azulclaro" then
        themeList = themeStyles.azulclaro
elseif themeList == "Gris" then
        themeList = themeStyles.Gris
elseif themeList == "lila" then
        themeList = themeStyles.lila
...
elseif themeList == "SynapseX" then
        themeList = themeStyles.SynapseX
...
game:GetService("Players").PlayerAdded:connect(function(plr)
	...
	object.Position = UDim2.new(0.5, 0, 0.4, 0)
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=9664958625"
    ...
    close.MouseButton1Click:Connect(function()
        game.TweenService:Create(close, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
            ImageTransparency = 1
        }):Play()
        wait()
        game.TweenService:Create(Main, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
